using DotnetBoilerplate.API.Setup;
...
namespace DotnetBoilerplate
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IApplicationSettings, ApplicationSettings>(_ => applicationSettings);
            services.AddDatabaseConnection(Configuration);
            services.AddMediator();
            services.AddAuthenticationConfiguration(applicationSettings);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetBoilerplate v1"));
            }
